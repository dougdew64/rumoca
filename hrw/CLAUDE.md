...
>
> **NIGHT 4 RAN — no live defect, second night running.** Its record asks whether these nights
> still earn their gate time on app-side code, and owes a ruling: [`docs/unattended-runs.md`](docs/unattended-runs.md).
>
