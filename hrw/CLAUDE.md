...
```text
cargo test -p hrw --lib -- --test-threads=1                        # ~8s,   417 tests — between edits
cargo test -p hrw --lib --features slow-tests -- --test-threads=1  # ~2min, 477 tests — before committing
