...
## Station 1 — Which declarations carry the past?
...
## Station 5 — What the compiler says when the claim fails
...
## Station 7 — Where it fails, and why that is the right place
