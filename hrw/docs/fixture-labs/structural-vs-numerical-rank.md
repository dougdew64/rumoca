...
## 📐 Station 1 — The pattern, from a real model
...
## 📐 Station 2 — What HRW concludes from it
...
## 🧮 Station 3 — Where the values go in
...
where the boundary lies is the point of the lab.
