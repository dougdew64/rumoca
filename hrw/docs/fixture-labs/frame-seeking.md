...
## Station 2 — Jump into the middle
...
A lab naming a frame that does not exist is a bug *in the lab*; landing on the last
frame would look deliberate and hide it.

## Station 5 — Seek in a different animation
...
## Station 6 — Seek a view that has no animation
...
algorithm, not about the mechanism, and it is the half a lab author gets wrong.
