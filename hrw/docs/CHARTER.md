...
**Decision 17 — The destination ranks work (PROPOSED v1.13, September 19, 2026).** *Section 1 states the destination; a purpose that ranks nothing changes nothing, so this is what gives it force.*
