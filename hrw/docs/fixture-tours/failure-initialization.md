...
**The question to hold:** every earlier tour showed something *missing* — a name, an equation, a
match. This phase can fail because there is **too much**.

---

## Stop 1 — More conditions than states
...
## Stop 3 — Everything downstream still runs
...
## Stop 4 — The determinacy verdict
