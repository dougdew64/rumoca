...
*derivatives*, as the DAE tour established — the integrator holds `h` and `v` and needs their
rates.
...
*What just happened.* **Square was never sufficient, and this is the proof the DAE tour promised
...
is true and it is unsettling; the tour states it and does not explore it.
