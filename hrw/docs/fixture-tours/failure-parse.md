...
subject of this tour, and until 2026-08-04 HRW could not always answer it.

---

## Stop 1 — The failure itself
...
## Stop 3 — The log agrees with the tabs

Click the **Log** toggle above the stage tabs. *(There is no tour-link form for the log. The
first draft of this stop invented one and the link checker rejected it — which is the checker
working: a link form that does not exist must not sit in a tour looking clickable.)*
...
## Stop 4 — The distinction this specimen anchors
...
- Did any tab show you something you could not tell the origin of? That is the defect this tour
  is hunting.
- Is *"not reached"* enough, or do you want the tab to say **which** phase stopped and why?
  Stop 2 shows the current wording; it is HRW's, not Rumoca's, and it can change.
