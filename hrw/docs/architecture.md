...
**68 modules, 79,563 lines**, largest first. Every `.rs` file under `src/` at any depth, including the test-only ones (`ui_tests.rs`, `test_support.rs`); a module in a subdirectory is keyed by its path relative to `src/`.

| module | lines |
|---|---:|
| `app.rs` | 7,388 |
| `worker/tests.rs` | 7,018 |
| `app/tests.rs` | 6,823 |
| `doc_citations.rs` | 6,419 |
| `worker.rs` | 6,058 |
| `bridge.rs` | 4,244 |
| `ui_tests.rs` | 3,054 |
| `fidelity.rs` | 1,849 |
| `equation_sheet.rs` | 1,540 |
| `diagnostics.rs` | 1,397 |
| `tree.rs` | 1,396 |
| `lab_panel.rs` | 1,338 |
| `autoplay.rs` | 1,317 |
...
rebase; [`running-things.md`](running-things.md) carries the commands, and the suite reports its
